...
$ curl -o actions-runner-linux-x64-2.285.1.tar.gz -L https://github.com/actions/runner/releases/download/v2.285.1/actions-runner-linux-x64-2.285.1.tar.gz # Optional: Validate the hash
...
$ ./config.sh --url https://github.com/iSTKr/Symphony_test --token AXB5DQ772M37V5I5SYHBAP3B2RI2K # Last step, run it!
$ ./run.sh
